...
\gls{HoTT} does not surmise that all possible proofs can be fully circumscribed by the rules of
the formal system, but accepts proofs that cannot be formalized in \gls{HoTT}.  These are
