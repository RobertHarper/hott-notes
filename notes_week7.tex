...
\section{Identity Types as Hom-sets in an $(\infty,1)$-Category}\label{}

Consider the following transport properties of the Identity type:

Define $E(x,y) := \Id{A}(x,y)$.
\begin{enumerate}
\item Fix $x_0:A$, and consider $y.E(x_0,y)$ as the motive for transporting
along $q:y=y'$:
\[
\tr[y.E(x_0,y)](q):E(x_0,y)\to E(x_0,y')
\]
If we apply some $p:E(x_0,y)$ to the term above, we get
\[
\tr[y.E(x_0,y)](q)(p) = (\J[a.b._.E(x_0,a)\to E(x_0,b)](q;x.\lambda w.w))(p)\\
\]
which is the same as $p \cdot q$! So $\tr[y.E(x_0,y)](q)$ can be seen as
the post-concatenation of $q$ to $p$.
\item
\end{enumerate}
